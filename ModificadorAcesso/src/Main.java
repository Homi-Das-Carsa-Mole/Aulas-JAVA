...
//		System.out.println(cliente1.getNumConta());
		...
		System.out.println(cliente1.toString()); //Método que mostra todos os dados de cliente.
		...
		//No entanto, se igualarmos ambos os objetos (cliente2 = cliente1), o cliente2 passará a apontar para o mesmo endereço da heap de cliente1. Agora eles são iguais.

		if(cliente1.getNome() == cliente2.getNome()) { //Comparação de atributo específico
			System.out.println("Os nomes são iguais.");
		} else {
			System.out.println("Os nomes são diferentes.");
		}
		
		if(cliente1.equals(cliente2)) { //Sem sobrescrever, ele comparará os endereços
